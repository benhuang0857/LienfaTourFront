...
import { getAllApi } from '@/api/tourInfo/continent'
...
const AddAction = () => {
  push('/basic-info/tour-info/continent-add')
}
...
const action = (row: TableData, type: string) => {
  push(`/basic-info/tour-info/continent-${type}?id=${row.id}`)
}
</script>
