...
import { getAllApi } from '@/api/basicInfo/branchoffice'
...
const AddAction = () => {
  push('/basic-info/company-employee/branchoffice-add')
}
...
const action = (row: TableData, type: string) => {
  push(`/basic-info/company-employee/branchoffice-${type}?id=${row.id}`)
}
</script>
