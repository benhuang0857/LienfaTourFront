...
export default [
  {
    url: '/apiv1/basic-info/headquarter/get',
    method: 'get',
    timeout,
    response: () => {
      return {
        ...
        data: {
          ...
          area: '台中',
          abbr_name: '連發國際',
          full_ch_name: '聯發國際旅行社有限公司',
          full_en_name: 'Lienfa International Co',
          brand_name: 'Lienfa',
          registration_number: 'AX109999',
          gui_number: 'G187954624754',
          tax_number: 'TA18888DF'
        }
      }
    }
  },
